...
% NOTE: To make sure that the only file that we need to change to compare different PlayerAction.m files make sure to put all your helpfiles inside this function.
