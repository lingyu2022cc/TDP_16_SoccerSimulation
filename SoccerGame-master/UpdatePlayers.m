function [updatedPlayers, updatedBall] = UpdatePlayers(players, ball, timeDelta, playerOriginalPosition,goalsTeam1, goalsTeam2)
...
for indexOfPlayer = 1:nPlayers
    % TODO, make sure the row/column formating is correct here
    [updatedPlayer, updatedBall] = UpdatePlayer(players, ball, indexOfPlayer, timeDelta, playerOriginalPosition,goalsTeam1,goalsTeam2);
